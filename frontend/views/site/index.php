        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
			...
			<span class="info-box-number">6</span>
              <span class="info-box-text">Operation Reports</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
			...
			<span class="info-box-number">8</span>
              <span class="info-box-text">Birth Reports</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
			...
			<span class="info-box-number">4</span>
              <span class="info-box-text">Death Reports</span>
	  ...
	  <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">OPD Earning</h3>
